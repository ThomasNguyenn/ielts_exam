...
export default function Layout() {
  ...
  return (
    <div className="layout">
      ...
      <main className={`layout-main ${isExamPage ? 'layout-main--fullscreen' : ''} ${isPracticePage ? 'layout-main--wide' : ''} ${isManagePage ? 'layout-main--manage' : ''} ${location.pathname === '/' ? 'layout-main--home' : ''}`}>
        <Outlet />
      </main>
    </div>
  );
