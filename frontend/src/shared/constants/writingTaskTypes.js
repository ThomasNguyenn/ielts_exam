...
/**
 * Get options for the writing task type dropdown based on task_type (task1/task2)
 * @param {string} taskType - 'task1' or 'task2'
 * @returns {Array<{value: string, label: string}>}
 */
export function getWritingTaskTypeOptions(taskType) {
  if (taskType === 'task2') {
    return [...WRITING_TASK_TYPES_TASK2, WRITING_TASK_TYPE_OTHER];
  }
  return [...WRITING_TASK_TYPES_TASK1, WRITING_TASK_TYPE_OTHER];
}
