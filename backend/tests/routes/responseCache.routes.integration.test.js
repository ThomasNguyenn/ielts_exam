...
const testControllerMocks = vi.hoisted(() => ({
  ...
  submitExamActivityOpen: vi.fn((_req, res) => res.status(200).json({ success: true })),
  submitExamActivityStart: vi.fn((_req, res) => res.status(200).json({ success: true })),
  submitExamActivityHeartbeat: vi.fn((_req, res) => res.status(200).json({ success: true })),
  submitExamActivityAnswer: vi.fn((_req, res) => res.status(200).json({ success: true })),
