...
describe("createRateLimiter", () => {
  it("allows requests until the max, then blocks with 429", async () => {
  ...
  it("skips rate limiting for OPTIONS preflight", async () => {
    const limiter = createRateLimiter({ max: 1, useRedis: false, keyGenerator: () => "fixed-client" });
