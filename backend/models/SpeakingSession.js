...
const SpeakingSessionSchema = new mongoose.Schema({
  ...
  scoring_state: {
    type: String,
    enum: ["processing", "provisional_ready", "phase1_ready", "phase2_ready", "completed", "failed"],
    default: "processing",
  },
  audio_upload_state: {
    type: String,
  ...
  audio_upload_started_at: { type: Date, default: null },
  audio_uploaded_at: { type: Date, default: null },
  audio_upload_error: { type: String, default: null },
  ...
  error_logs_started_at: { type: Date, default: null },
  error_logs_ready_at: { type: Date, default: null },
  error_logs_error: { type: String, default: null },
  error_logs_source: { type: String, default: null },
  ...
  phase2_analysis: { type: mongoose.Schema.Types.Mixed, default: null },
